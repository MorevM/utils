...
import type { ObjectLong, ObjectLongAlpha, ObjectLongMaybeAlpha, ObjectShort, ObjectShortAlpha, ObjectShortMaybeAlpha, RgbArray, RgbArrayAlpha, RgbArrayMaybeAlpha } from '../types';
