 ...
 * @param     {string}           axis      Consider only one axis (`x`, `y`) or both
 *
 * @returns   {Element|Window}             The nearest scrollable ancestor element of a given element, or the `window` object.
 */
